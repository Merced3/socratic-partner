...
- [`product-thesis.md`](product-thesis.md) — purpose, outcome hypotheses, and preserving the reason behind decisions
...
- [`roadmap.md`](roadmap.md) — release completion, post-v0.1 direction, and session transfer
